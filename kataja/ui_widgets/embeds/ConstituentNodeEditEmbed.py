...
class EyeButton(PanelButton):
    ...
    def __init__(self, key, value, tt):
    ...
    def update_icon_mode(self):
        ...
        if self._hover and not down:
            ...
            self.setIcon(self.checked_icon)
        elif self.get_watched_value() == self.value:
            self.setIcon(self.hover_icon)
        else:
            self.setIcon(self.normal_icon)

    def get_watched_value(self):
...
class ConstituentNodeEditEmbed(UIEmbed):
    ...
    def __init__(self, parent, node):
        ...
        self.synframebutton = EyeButton('synlabels', g.SYN_LABELS,
                                        'All nodes show their syntactic labels')
        self.ui_manager.connect_element_to_action(self.synframebutton,
                                                  'set_visible_labels_to_synlabels')
        ...
        self.nodeframebutton = EyeButton('nodelabels', g.NODE_LABELS,
                                         'All nodes show their user-given labels')
        self.view_buttons.addButton(self.nodeframebutton)
        self.ui_manager.connect_element_to_action(self.nodeframebutton,
                                                  'set_visible_labels_to_nodelabels')
        ...
        self.autoframebutton = EyeButton('autolabels', g.XBAR_LABELS,
                                         'All nodes show their autogenerated x-bar labels')
        self.ui_manager.connect_element_to_action(self.autoframebutton,
                                                  'set_visible_labels_to_autolabels')
