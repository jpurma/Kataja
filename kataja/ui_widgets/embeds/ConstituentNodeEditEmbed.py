...
class ConstituentNodeEditEmbed(UIEmbed):
    ...
    def __init__(self, parent, node):
        ...
        self.synframebutton = EyeButton(action='set_visible_labels_to_synlabels',
                                        tooltip='All nodes show their syntactic labels')
        ...
        self.nodeframebutton = EyeButton(action='set_visible_labels_to_nodelabels',
                                         tooltip='All nodes show their user-given labels')
        ...
        self.autoframebutton = EyeButton(action='set_visible_labels_to_autolabels',
                                         tooltip='All nodes show their autogenerated x-bar labels')
