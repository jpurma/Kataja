...
class LayeredParser(BaseParser):
    ...
    def _new_merge(self, args):
        ...
        for arg in args:
            ...
            if isinstance(arg, ctrl.syntax.Constituent):
                children.append(arg)
        ...
        node.update_label()
        f.derivation_tree.save_and_create_derivation_step()
        return constituent
    ...
    def _new_constituent(self, args):
        ...
        for arg in features:
            if isinstance(arg, ctrl.syntax.Feature):
    ...
    def _new_command(self, command, args=None):
        ...
        if command in commands:
            ...
            feature = ctrl.syntax.Feature(name=command, value=''.join(args))
            return feature
