...
from kataja.plugins.StacklessShifter.Analyzer import Analyzer
...
class SyntaxAPI(KatajaSyntaxAPI):
    ...
    def __init__(self, lexicon=None):
        super().__init__()
        self.parser = Analyzer(lexicon=lexicon, forest=None)
    ...
    def create_derivation(self, input_text=None, lexicon=None, semantics=None, forest=None):
        ...
        if self.input_text.startswith('['):
            self.parser.analyze_and_make_features(self.input_text)
        else:
