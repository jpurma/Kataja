# coding=utf-8
from kataja.plugins.StacklessShifter.Document import Document
from kataja.plugins.StacklessShifter.SyntaxAPI import SyntaxAPI
...
plugin_classes = [Document, SyntaxAPI]
...
reload_order = ['StacklessShifter.SyntaxAPI', 'StacklessShifter.Document', 'StacklessShifter.StacklessShiftParser',
                'StacklessShifter.setup']
