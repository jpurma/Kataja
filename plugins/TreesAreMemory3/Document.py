...
from plugins.TreesAreMemory3.Parser import read_lexicon, linearize
...
class Document(KatajaDocument):
    ...
    def get_default_treeset_file():
        return os.path.join(ctrl.main.plugin_manager.active_plugin_path, 'sentences_en.txt')
