...
from plugins.TreesAreMemory3.Document import Document
from plugins.TreesAreMemory3.SyntaxAPI import SyntaxAPI
...
reload_order = ['TreesAreMemory3.Feature', 'TreesAreMemory3.Constituent', 'TreesAreMemory3.SyntaxAPI',
                'TreesAreMemory3.Document', 'TreesAreMemory3.Parser', 'TreesAreMemory3.setup']
