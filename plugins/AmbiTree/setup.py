# coding=utf-8
from plugins.AmbiTree.Constituent import Constituent
from plugins.AmbiTree.Document import Document
from plugins.AmbiTree.Feature import Feature
from plugins.AmbiTree.SyntaxAPI import SyntaxAPI
...
reload_order = ['AmbiTree.Feature', 'AmbiTree.Constituent', 'AmbiTree.SyntaxAPI', 'AmbiTree.Document',
                'AmbiTree.Parser',
                'AmbiTree.setup']
