# coding=utf-8
from plugins.OrderlessTree.Constituent import Constituent
from plugins.OrderlessTree.Document import Document
from plugins.OrderlessTree.Feature import Feature
from plugins.OrderlessTree.SyntaxAPI import SyntaxAPI
...
reload_order = ['OrderlessTree.Feature', 'OrderlessTree.Constituent', 'OrderlessTree.SyntaxAPI',
                'OrderlessTree.Document', 'OrderlessTree.Parser',
                'OrderlessTree.setup']
