# coding=utf-8
from plugins.Monorail.Constituent import Constituent
from plugins.Monorail.Document import Document
from plugins.Monorail.SyntaxAPI import SyntaxAPI
...
# 2. KatajaMain.enable_plugin calls plugin's start_plugin-method (optional)
...
#   When you navigate into Forest instance with (not self.is_parsed), it attempts to parse it by calling
