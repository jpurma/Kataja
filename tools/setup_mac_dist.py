...
At the moment it supports building deployable standalone version for OS X. Requires Python3.7,
setuptools,
Qt5.8 and PyQt6 on the build machine, but the created app doesn't need them.
...
if sys.platform == 'darwin':
    plist = {
        ...
        'NSHumanReadableCopyright': '© 2018 Jukka Purma, GNU General Public License 3'
    }
    ...
    OPTIONS = {
        'py2app': {
            ...
            'plist': plist,
            'site_packages': False,
            'includes': ['sip', 'PyQt6', 'PyQt6.QtCore', 'PyQt6.QtGui', 'PyQt6.QtMultimedia',
                         'PyQt6.QtNetwork', 'PyQt6.QtMultimediaWidgets', 'PyQt6.QtOpenGL',
                         'PyQt6.QtDBus', 'PyQt6.QtPrintSupport', 'PyQt6.QtSvg'],
            'excludes': ['PyQt6.uic']
        }
    }
    extra_options = {
    ...
    DATA_FILES = [("platforms",
                   ["C:\\Python34\\Lib\\site-packages\\PyQt6\\plugins\\platforms\\qwindows.dll"]), (
                      "imageformats",
                      ["C:\\Python34\\Lib\\site-packages\\PyQt6\\plugins\\imageformats\\qgif.dll"])]
...
if sys.platform == 'darwin':
    ...
    for ef in list(frameworks):
        for fr in list(frameworks):
            file = app_contents + 'Resources/lib/python3.7/lib-dynload/PyQt6/' + ef + '.so'
