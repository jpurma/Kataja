...
setup(
    ...
    description='Visualising minimalist grammars',  # Optional
    ...
    url='https://github.com/jpurma/kataja',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Jukka Purma',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='jukka.purma@aalto.fi',  # Optional
    ...
    keywords='syntax tree visualization grammar minimalism biolinguistics',  # Optional
